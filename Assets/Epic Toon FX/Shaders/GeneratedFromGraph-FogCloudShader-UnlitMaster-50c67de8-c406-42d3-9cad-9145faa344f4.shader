Shader "Unlit Master Cloud"
{
    Properties
    {
        _scrollSpeed("Scroll Speed", Float) = 0.5
        Color_8913FFBC("Color1", Color) = (0.9056604, 0.5339979, 0.5339979, 0)
        Color_2379A018("Color2", Color) = (0.9433962, 0.9118925, 0.1557494, 0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
            {
                ...
                float3 _Add_33637610_Out_2;
                Unity_Add_float3(IN.WorldSpacePosition, _Multiply_3C151A4E_Out_2, _Add_33637610_Out_2);
                float3 _Transform_AD6B134C_Out_1 = TransformWorldToObject(_Add_33637610_Out_2.xyz);
